...
if s3_file_exists(input_bucket, input_key):
    ...
    passed_records_path = f"s3://{bkt_params[env]['DQ_DATA_BKT']}/batch_dq_recordlevel/accounting/pass/{rec_type}/{current_date}/"
    failed_records_path = f"s3://{bkt_params[env]['DQ_DATA_BKT']}/batch_dq_recordlevel/accounting/fail/{rec_type}/{current_date}/"
